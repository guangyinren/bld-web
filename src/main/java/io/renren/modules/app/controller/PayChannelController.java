...
public class PayChannelController {
    ...
    public R save(@RequestBody PayChannelEntity payChannel){
    ...
    public R update(@RequestBody PayChannelEntity payChannel){
    ...
    public R delete(@RequestBody String[] payChannelIds){
