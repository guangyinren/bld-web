 ...
 */
@RestController
@RequestMapping("app/contributelog")
public class ContributeLogController {
    @Autowired
    ...
    public R save(@RequestBody ContributeLogEntity contributeLog){
    ...
    public R update(@RequestBody ContributeLogEntity contributeLog){
    ...
    public R delete(@RequestBody String[] contributeLogIds){
