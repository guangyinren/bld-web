...
public class PublicAccountApiController {
    @Autowired
    ...
    public R save(PublicAccountEntity publicAccount){
    ...
    public R update(PublicAccountEntity publicAccount){
    ...
    public R delete(Long[] publicAccountIds){
